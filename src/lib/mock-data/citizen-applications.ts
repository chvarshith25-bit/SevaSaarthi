...
export const CITIZEN_APPLICATIONS: CitizenTrackedApplication[] = [
  ...
  },
  {
    ...
    serviceId: "s001",
    department: "Department of Higher Education (NSP)",
    ...
    trackingUrl: "/track/NSP-2026-8812",
    steps: [
      { label: "Submitted", date: "5 Sept", status: "COMPLETED" },
      { label: "AISHE Verification", date: "6 Sept", status: "COMPLETED" },
      { label: "Verification in Progress", status: "ACTIVE" },
      { label: "State Officer Sanction", status: "PENDING" },
      { label: "DBT Disbursal", status: "PENDING" },
      { label: "Completed", status: "PENDING" },
    ],
  },
  {
