        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredDocs.map((doc) => {
            ...
            return (
              <div
                key={doc.id}
                className="bg-white rounded-2xl border border-slate-100 p-5 shadow-xs hover:border-indigo-200 hover:shadow-md transition-all flex flex-col justify-between overflow-hidden"
              >
                <div>
                  {/* Top Status & Type */}
