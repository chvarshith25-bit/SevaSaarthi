      ...
      <div className="bg-white rounded-3xl max-w-lg w-full p-6 shadow-2xl border border-slate-100 relative max-h-[90vh] overflow-y-auto">
        ...
        <div className="mb-5">
          ...
          <p className="text-xs text-slate-500 mt-0.5">
            Select your document category and choose your file to securely store it for your applications.
          </p>
        </div>
          ...
          <div className="flex flex-wrap gap-1.5">
            {docTypes.slice(0, 4).map((dt) => (
              <button
                ...
                className="px-2.5 py-1 bg-white hover:bg-indigo-50 border border-slate-200/80 hover:border-indigo-300 rounded-lg text-[10px] font-semibold text-slate-700 hover:text-indigo-700 transition-colors cursor-pointer"
              >
        ...
        <div className="flex items-center justify-end gap-3 mt-6 pt-4 border-t border-slate-100">
          ...
          <button
            ...
            className="px-5 py-2.5 bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 text-white text-xs font-bold rounded-xl shadow-sm shadow-indigo-200 transition-all flex items-center gap-2 cursor-pointer"
          >
            {isUploading ? (
              <>
